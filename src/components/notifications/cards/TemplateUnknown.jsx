...
export default function TemplateUnknown({variables}) {
  ...
  return (
    <View style={styles.wrapper(globalSettings.notification, selectedTheme)}>
      <View style={styles.headerContainer}>
        <Text style={styles.headerText(selectedTheme)}>Unknown Template</Text>
      </View>
      <View>
        <Text style={styles.bodyText(selectedTheme)}>
          Please use a template outlined in the README of this project.
        </Text>
      </View>
    </View>
  );
